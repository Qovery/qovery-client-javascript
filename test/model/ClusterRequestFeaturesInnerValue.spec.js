...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ClusterRequestFeaturesInnerValue();
  });
  ...
  describe('ClusterRequestFeaturesInnerValue', function() {
    it('should create an instance of ClusterRequestFeaturesInnerValue', function() {
      // uncomment below and update the code to test ClusterRequestFeaturesInnerValue
      //var instance = new QoveryApi.ClusterRequestFeaturesInnerValue();
      //expect(instance).to.be.a(QoveryApi.ClusterRequestFeaturesInnerValue);
    });
