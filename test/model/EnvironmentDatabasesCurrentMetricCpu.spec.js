...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentDatabasesCurrentMetricCpu();
  });
  ...
  describe('EnvironmentDatabasesCurrentMetricCpu', function() {
    it('should create an instance of EnvironmentDatabasesCurrentMetricCpu', function() {
      // uncomment below and update the code to test EnvironmentDatabasesCurrentMetricCpu
      //var instance = new QoveryApi.EnvironmentDatabasesCurrentMetricCpu();
      //expect(instance).to.be.a(QoveryApi.EnvironmentDatabasesCurrentMetricCpu);
    });
