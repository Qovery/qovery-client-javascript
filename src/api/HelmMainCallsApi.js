...
export default class HelmMainCallsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the listHelmLinks operation.
     * @callback module:api/HelmMainCallsApi~listHelmLinksCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} helmId Helm ID
     * @param {module:api/HelmMainCallsApi~listHelmLinksCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LinkResponseList}
     */
    listHelmLinks(helmId, callback) {
      let postBody = null;
      // verify the required parameter 'helmId' is set
      if (helmId === undefined || helmId === null) {
        throw new Error("Missing the required parameter 'helmId' when calling listHelmLinks");
      }
