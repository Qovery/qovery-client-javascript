...
export default class HelmCustomDomainApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createHelmCustomDomain operation.
     * @callback module:api/HelmCustomDomainApi~createHelmCustomDomainCallback
     ...
     * @param {module:api/HelmCustomDomainApi~createHelmCustomDomainCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomDomain}
     */
    createHelmCustomDomain(helmId, opts, callback) {
      opts = opts || {};
      let postBody = opts['customDomainRequest'];
      // verify the required parameter 'helmId' is set
      if (helmId === undefined || helmId === null) {
        throw new Error("Missing the required parameter 'helmId' when calling createHelmCustomDomain");
      }
    ...
    /**
     * Callback function to receive the result of the listHelmCustomDomain operation.
     * @callback module:api/HelmCustomDomainApi~listHelmCustomDomainCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} helmId Helm ID
     * @param {module:api/HelmCustomDomainApi~listHelmCustomDomainCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomDomainResponseList}
     */
    listHelmCustomDomain(helmId, callback) {
      let postBody = null;
      // verify the required parameter 'helmId' is set
      if (helmId === undefined || helmId === null) {
        throw new Error("Missing the required parameter 'helmId' when calling listHelmCustomDomain");
      }
