...
class ManagedDatabaseTypeResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>ManagedDatabaseTypeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagedDatabaseTypeResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ManagedDatabaseTypeResponse.RequiredProperties) {
            if (!data[property]) {
...
ManagedDatabaseTypeResponse.RequiredProperties = ["name"];
