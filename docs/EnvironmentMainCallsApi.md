# BetaQoveryApi.EnvironmentMainCallsApi
...
let apiInstance = new BetaQoveryApi.EnvironmentMainCallsApi();
...
let environmentId = "environmentId_example"; // String | Environment ID
let opts = {
  'environmentEditRequest': new BetaQoveryApi.EnvironmentEditRequest() // EnvironmentEditRequest | 
};
