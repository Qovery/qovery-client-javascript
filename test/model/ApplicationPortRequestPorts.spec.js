...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ApplicationPortRequestPorts();
  });
  ...
  describe('ApplicationPortRequestPorts', function() {
    it('should create an instance of ApplicationPortRequestPorts', function() {
      ...
      //var instance = new QoveryApi.ApplicationPortRequestPorts();
      //expect(instance).to.be.a(QoveryApi.ApplicationPortRequestPorts);
    });
