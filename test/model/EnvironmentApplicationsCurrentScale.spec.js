...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentApplicationsCurrentScale();
  });
  ...
  describe('EnvironmentApplicationsCurrentScale', function() {
    it('should create an instance of EnvironmentApplicationsCurrentScale', function() {
      // uncomment below and update the code to test EnvironmentApplicationsCurrentScale
      //var instance = new QoveryApi.EnvironmentApplicationsCurrentScale();
      //expect(instance).to.be.a(QoveryApi.EnvironmentApplicationsCurrentScale);
    });
