...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.MetricStorageDatapoint();
  });
  ...
  describe('MetricStorageDatapoint', function() {
    it('should create an instance of MetricStorageDatapoint', function() {
      // uncomment below and update the code to test MetricStorageDatapoint
      //var instance = new QoveryApi.MetricStorageDatapoint();
      //expect(instance).to.be.a(QoveryApi.MetricStorageDatapoint);
    });
