...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ApplicationEditRequestAllOf();
  });
  ...
  describe('ApplicationEditRequestAllOf', function() {
    it('should create an instance of ApplicationEditRequestAllOf', function() {
      // uncomment below and update the code to test ApplicationEditRequestAllOf
      //var instance = new QoveryApi.ApplicationEditRequestAllOf();
      //expect(instance).to.be.a(QoveryApi.ApplicationEditRequestAllOf);
    });
