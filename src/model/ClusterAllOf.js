...
class ClusterAllOf {
     ...
     */
    constructor(organization, name, region, cloudProvider) { 
        
        ClusterAllOf.initialize(this, organization, name, region, cloudProvider);
    }
     ...
     */
    static initialize(obj, organization, name, region, cloudProvider) { 
