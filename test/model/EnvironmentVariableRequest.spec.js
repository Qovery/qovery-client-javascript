...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.EnvironmentVariableRequest();
  });
  ...
  describe('EnvironmentVariableRequest', function() {
    it('should create an instance of EnvironmentVariableRequest', function() {
      ...
      //var instance = new BetaQoveryApi.EnvironmentVariableRequest();
      //expect(instance).to.be.a(BetaQoveryApi.EnvironmentVariableRequest);
    });
