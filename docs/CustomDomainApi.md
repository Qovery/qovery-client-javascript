...
let apiInstance = new BetaQoveryApi.CustomDomainApi();
let applicationId = "applicationId_example"; // String | Application ID
let opts = {
  'customDomainRequest': new BetaQoveryApi.CustomDomainRequest() // CustomDomainRequest | 
};
