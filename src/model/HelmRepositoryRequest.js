...
class HelmRepositoryRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>HelmRepositoryRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HelmRepositoryRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HelmRepositoryRequest.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['config']) { // data not null
          HelmRepositoryRequestConfig.validateJSON(data['config']);
        }
...
HelmRepositoryRequest.RequiredProperties = ["name", "kind", "skip_tls_verification", "config"];
