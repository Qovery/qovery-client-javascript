...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ApplicationRequestAllOf();
  });
  ...
  describe('ApplicationRequestAllOf', function() {
    it('should create an instance of ApplicationRequestAllOf', function() {
      // uncomment below and update the code to test ApplicationRequestAllOf
      //var instance = new QoveryApi.ApplicationRequestAllOf();
      //expect(instance).to.be.a(QoveryApi.ApplicationRequestAllOf);
    });
