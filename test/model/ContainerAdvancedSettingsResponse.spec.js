...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ContainerAdvancedSettingsResponse();
  });
  ...
  describe('ContainerAdvancedSettingsResponse', function() {
    it('should create an instance of ContainerAdvancedSettingsResponse', function() {
      // uncomment below and update the code to test ContainerAdvancedSettingsResponse
      //var instance = new QoveryApi.ContainerAdvancedSettingsResponse();
      //expect(instance).to.be.a(QoveryApi.ContainerAdvancedSettingsResponse);
    });
