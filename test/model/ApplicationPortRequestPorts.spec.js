...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ApplicationPortRequestPorts();
  });
  ...
  describe('ApplicationPortRequestPorts', function() {
    it('should create an instance of ApplicationPortRequestPorts', function() {
      // uncomment below and update the code to test ApplicationPortRequestPorts
      //var instance = new BetaQoveryApi.ApplicationPortRequestPorts();
      //expect(instance).to.be.a(BetaQoveryApi.ApplicationPortRequestPorts);
    });
