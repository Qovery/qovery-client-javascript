...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.JobRequestAllOfScheduleCronjob();
  });
  ...
  describe('JobRequestAllOfScheduleCronjob', function() {
    it('should create an instance of JobRequestAllOfScheduleCronjob', function() {
      // uncomment below and update the code to test JobRequestAllOfScheduleCronjob
      //var instance = new QoveryApi.JobRequestAllOfScheduleCronjob();
      //expect(instance).to.be.a(QoveryApi.JobRequestAllOfScheduleCronjob);
    });
