...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.DatabaseCurrentMetricStorage();
  });
  ...
  describe('DatabaseCurrentMetricStorage', function() {
    it('should create an instance of DatabaseCurrentMetricStorage', function() {
      // uncomment below and update the code to test DatabaseCurrentMetricStorage
      //var instance = new QoveryApi.DatabaseCurrentMetricStorage();
      //expect(instance).to.be.a(QoveryApi.DatabaseCurrentMetricStorage);
    });
