...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ApplicationConfigurationApi();
  });
  ...
  describe('ApplicationConfigurationApi', function() {
    ...
    describe('getApplicationNetwork', function() {
      it('should call getApplicationNetwork successfully', function(done) {
        //uncomment below and update the code to test getApplicationNetwork
        //instance.getApplicationNetwork(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
