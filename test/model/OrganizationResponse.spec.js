...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.OrganizationResponse();
  });
  ...
  describe('OrganizationResponse', function() {
    it('should create an instance of OrganizationResponse', function() {
      ...
      //var instance = new BetaQoveryApi.OrganizationResponse();
      //expect(instance).to.be.a(BetaQoveryApi.OrganizationResponse);
    });
