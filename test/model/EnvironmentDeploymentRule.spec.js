...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentDeploymentRule();
  });
  ...
  describe('EnvironmentDeploymentRule', function() {
    it('should create an instance of EnvironmentDeploymentRule', function() {
      // uncomment below and update the code to test EnvironmentDeploymentRule
      //var instance = new QoveryApi.EnvironmentDeploymentRule();
      //expect(instance).to.be.a(QoveryApi.EnvironmentDeploymentRule);
    });
