...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentDeploymentRuleResponseAllOf();
  });
  ...
  describe('EnvironmentDeploymentRuleResponseAllOf', function() {
    it('should create an instance of EnvironmentDeploymentRuleResponseAllOf', function() {
      // uncomment below and update the code to test EnvironmentDeploymentRuleResponseAllOf
      //var instance = new QoveryApi.EnvironmentDeploymentRuleResponseAllOf();
      //expect(instance).to.be.a(QoveryApi.EnvironmentDeploymentRuleResponseAllOf);
    });
