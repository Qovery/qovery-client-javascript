...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentVariableResponseAllOf();
  });
  ...
  describe('EnvironmentVariableResponseAllOf', function() {
    it('should create an instance of EnvironmentVariableResponseAllOf', function() {
      // uncomment below and update the code to test EnvironmentVariableResponseAllOf
      //var instance = new QoveryApi.EnvironmentVariableResponseAllOf();
      //expect(instance).to.be.a(QoveryApi.EnvironmentVariableResponseAllOf);
    });
