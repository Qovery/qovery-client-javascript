...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.JobActionsApi();
  });
  ...
  describe('JobActionsApi', function() {
    describe('deployJob', function() {
      it('should call deployJob successfully', function(done) {
        //uncomment below and update the code to test deployJob
        //instance.deployJob(function(error) {
