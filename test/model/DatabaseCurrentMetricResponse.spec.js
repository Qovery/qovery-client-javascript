...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.DatabaseCurrentMetricResponse();
  });
  ...
  describe('DatabaseCurrentMetricResponse', function() {
    it('should create an instance of DatabaseCurrentMetricResponse', function() {
      // uncomment below and update the code to test DatabaseCurrentMetricResponse
      //var instance = new BetaQoveryApi.DatabaseCurrentMetricResponse();
      //expect(instance).to.be.a(BetaQoveryApi.DatabaseCurrentMetricResponse);
    });
