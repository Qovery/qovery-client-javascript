...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.LifecycleJobResponse();
  });
  ...
  describe('LifecycleJobResponse', function() {
    it('should create an instance of LifecycleJobResponse', function() {
      // uncomment below and update the code to test LifecycleJobResponse
      //var instance = new QoveryApi.LifecycleJobResponse();
      //expect(instance).to.be.a(QoveryApi.LifecycleJobResponse);
    });
