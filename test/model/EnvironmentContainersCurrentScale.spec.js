...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentContainersCurrentScale();
  });
  ...
  describe('EnvironmentContainersCurrentScale', function() {
    it('should create an instance of EnvironmentContainersCurrentScale', function() {
      // uncomment below and update the code to test EnvironmentContainersCurrentScale
      //var instance = new QoveryApi.EnvironmentContainersCurrentScale();
      //expect(instance).to.be.a(QoveryApi.EnvironmentContainersCurrentScale);
    });
