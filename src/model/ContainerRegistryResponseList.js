...
class ContainerRegistryResponseList {
    ...
    /**
     * Validates the JSON data with respect to <code>ContainerRegistryResponseList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContainerRegistryResponseList</code>.
     */
    static validateJSON(data) {
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                ContainerRegistryResponse.validateJSON(item);
            };
        }
