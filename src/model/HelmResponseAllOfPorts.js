...
class HelmResponseAllOfPorts {
    ...
    /**
     * Validates the JSON data with respect to <code>HelmResponseAllOfPorts</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HelmResponseAllOfPorts</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HelmResponseAllOfPorts.RequiredProperties) {
            if (!data[property]) {
...
HelmResponseAllOfPorts.RequiredProperties = ["id", "internal_port", "service_name", "protocol"];
