...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.HelmResponseAllOfSourceRepository();
  });
  ...
  describe('HelmResponseAllOfSourceRepository', function() {
    it('should create an instance of HelmResponseAllOfSourceRepository', function() {
      // uncomment below and update the code to test HelmResponseAllOfSourceRepository
      //var instance = new QoveryApi.HelmResponseAllOfSourceRepository();
      //expect(instance).to.be.a(QoveryApi.HelmResponseAllOfSourceRepository);
    });
