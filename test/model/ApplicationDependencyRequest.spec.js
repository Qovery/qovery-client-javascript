...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ApplicationDependencyRequest();
  });
  ...
  describe('ApplicationDependencyRequest', function() {
    it('should create an instance of ApplicationDependencyRequest', function() {
      ...
      //var instance = new BetaQoveryApi.ApplicationDependencyRequest();
      //expect(instance).to.be.a(BetaQoveryApi.ApplicationDependencyRequest);
    });
