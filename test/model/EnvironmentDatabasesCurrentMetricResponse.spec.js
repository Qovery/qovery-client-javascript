...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.EnvironmentDatabasesCurrentMetricResponse();
  });
  ...
  describe('EnvironmentDatabasesCurrentMetricResponse', function() {
    it('should create an instance of EnvironmentDatabasesCurrentMetricResponse', function() {
      // uncomment below and update the code to test EnvironmentDatabasesCurrentMetricResponse
      //var instance = new BetaQoveryApi.EnvironmentDatabasesCurrentMetricResponse();
      //expect(instance).to.be.a(BetaQoveryApi.EnvironmentDatabasesCurrentMetricResponse);
    });
