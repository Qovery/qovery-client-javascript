...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.EnvironmentDeploymentRuleApi();
  });
  ...
  describe('EnvironmentDeploymentRuleApi', function() {
    ...
    describe('getEnvironmentDeploymentRule', function() {
      it('should call getEnvironmentDeploymentRule successfully', function(done) {
        //uncomment below and update the code to test getEnvironmentDeploymentRule
        //instance.getEnvironmentDeploymentRule(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
