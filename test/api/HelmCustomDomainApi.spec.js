...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.HelmCustomDomainApi();
  });
  ...
  describe('HelmCustomDomainApi', function() {
    describe('deleteHelmCustomDomain', function() {
      it('should call deleteHelmCustomDomain successfully', function(done) {
        ...
        //instance.deleteHelmCustomDomain(function(error) {
    ...
    describe('editHelmCustomDomain', function() {
      it('should call editHelmCustomDomain successfully', function(done) {
        //uncomment below and update the code to test editHelmCustomDomain
        //instance.editHelmCustomDomain(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getHelmCustomDomain', function() {
