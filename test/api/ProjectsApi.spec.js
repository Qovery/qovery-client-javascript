...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ProjectsApi();
  });
  ...
  describe('ProjectsApi', function() {
    ...
    describe('getOrganizationProjectStats', function() {
      it('should call getOrganizationProjectStats successfully', function(done) {
        //uncomment below and update the code to test getOrganizationProjectStats
        //instance.getOrganizationProjectStats(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
