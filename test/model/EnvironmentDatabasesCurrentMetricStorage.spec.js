...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentDatabasesCurrentMetricStorage();
  });
  ...
  describe('EnvironmentDatabasesCurrentMetricStorage', function() {
    it('should create an instance of EnvironmentDatabasesCurrentMetricStorage', function() {
      // uncomment below and update the code to test EnvironmentDatabasesCurrentMetricStorage
      //var instance = new QoveryApi.EnvironmentDatabasesCurrentMetricStorage();
      //expect(instance).to.be.a(QoveryApi.EnvironmentDatabasesCurrentMetricStorage);
    });
