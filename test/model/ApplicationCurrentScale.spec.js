...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ApplicationCurrentScale();
  });
  ...
  describe('ApplicationCurrentScale', function() {
    it('should create an instance of ApplicationCurrentScale', function() {
      // uncomment below and update the code to test ApplicationCurrentScale
      //var instance = new QoveryApi.ApplicationCurrentScale();
      //expect(instance).to.be.a(QoveryApi.ApplicationCurrentScale);
    });
