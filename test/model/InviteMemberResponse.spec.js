...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.InviteMemberResponse();
  });
  ...
  describe('InviteMemberResponse', function() {
    it('should create an instance of InviteMemberResponse', function() {
      ...
      //var instance = new BetaQoveryApi.InviteMemberResponse();
      //expect(instance).to.be.a(BetaQoveryApi.InviteMemberResponse);
    });
