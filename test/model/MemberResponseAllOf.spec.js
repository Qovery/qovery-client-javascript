...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.MemberResponseAllOf();
  });
  ...
  describe('MemberResponseAllOf', function() {
    it('should create an instance of MemberResponseAllOf', function() {
      // uncomment below and update the code to test MemberResponseAllOf
      //var instance = new QoveryApi.MemberResponseAllOf();
      //expect(instance).to.be.a(QoveryApi.MemberResponseAllOf);
    });
