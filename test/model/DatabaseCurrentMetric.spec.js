...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.DatabaseCurrentMetric();
  });
  ...
  describe('DatabaseCurrentMetric', function() {
    it('should create an instance of DatabaseCurrentMetric', function() {
      // uncomment below and update the code to test DatabaseCurrentMetric
      //var instance = new QoveryApi.DatabaseCurrentMetric();
      //expect(instance).to.be.a(QoveryApi.DatabaseCurrentMetric);
    });
