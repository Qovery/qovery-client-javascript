...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ServiceResponseAllOf();
  });
  ...
  describe('ServiceResponseAllOf', function() {
    it('should create an instance of ServiceResponseAllOf', function() {
      // uncomment below and update the code to test ServiceResponseAllOf
      //var instance = new QoveryApi.ServiceResponseAllOf();
      //expect(instance).to.be.a(QoveryApi.ServiceResponseAllOf);
    });
