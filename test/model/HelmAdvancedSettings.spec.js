...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.HelmAdvancedSettings();
  });
  ...
  describe('HelmAdvancedSettings', function() {
    it('should create an instance of HelmAdvancedSettings', function() {
      // uncomment below and update the code to test HelmAdvancedSettings
