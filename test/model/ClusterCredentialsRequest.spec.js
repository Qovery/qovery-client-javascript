...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ClusterCredentialsRequest();
  });
  ...
  describe('ClusterCredentialsRequest', function() {
    it('should create an instance of ClusterCredentialsRequest', function() {
      // uncomment below and update the code to test ClusterCredentialsRequest
      //var instance = new BetaQoveryApi.ClusterCredentialsRequest();
      //expect(instance).to.be.a(BetaQoveryApi.ClusterCredentialsRequest);
    });
