...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ProjectDeploymentRule();
  });
  ...
  describe('ProjectDeploymentRule', function() {
    it('should create an instance of ProjectDeploymentRule', function() {
      // uncomment below and update the code to test ProjectDeploymentRule
      //var instance = new QoveryApi.ProjectDeploymentRule();
      //expect(instance).to.be.a(QoveryApi.ProjectDeploymentRule);
    });
