...
class EnvironmentResponseList {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [Environment]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EnvironmentResponseList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnvironmentResponseList</code>.
     */
...
/**
 * @member {Array.<module:model/Environment>} results
 */
