...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.StorageDisk();
  });
  ...
  describe('StorageDisk', function() {
    it('should create an instance of StorageDisk', function() {
      // uncomment below and update the code to test StorageDisk
      //var instance = new QoveryApi.StorageDisk();
      //expect(instance).to.be.a(QoveryApi.StorageDisk);
    });
