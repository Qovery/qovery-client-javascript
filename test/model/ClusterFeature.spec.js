...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ClusterFeature();
  });
  ...
  describe('ClusterFeature', function() {
    it('should create an instance of ClusterFeature', function() {
      // uncomment below and update the code to test ClusterFeature
      //var instance = new QoveryApi.ClusterFeature();
      //expect(instance).to.be.a(QoveryApi.ClusterFeature);
    });
