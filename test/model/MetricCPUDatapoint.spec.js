...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.MetricCPUDatapoint();
  });
  ...
  describe('MetricCPUDatapoint', function() {
    it('should create an instance of MetricCPUDatapoint', function() {
      // uncomment below and update the code to test MetricCPUDatapoint
      //var instance = new QoveryApi.MetricCPUDatapoint();
      //expect(instance).to.be.a(QoveryApi.MetricCPUDatapoint);
    });
