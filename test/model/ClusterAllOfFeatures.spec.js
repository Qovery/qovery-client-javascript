...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ClusterAllOfFeatures();
  });
  ...
  describe('ClusterAllOfFeatures', function() {
    it('should create an instance of ClusterAllOfFeatures', function() {
      // uncomment below and update the code to test ClusterAllOfFeatures
      //var instance = new QoveryApi.ClusterAllOfFeatures();
      //expect(instance).to.be.a(QoveryApi.ClusterAllOfFeatures);
    });
