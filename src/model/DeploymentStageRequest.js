...
class DeploymentStageRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>DeploymentStageRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeploymentStageRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeploymentStageRequest.RequiredProperties) {
            if (!data[property]) {
...
DeploymentStageRequest.RequiredProperties = ["name"];
