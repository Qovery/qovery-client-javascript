...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.InviteMemberResponseAllOf();
  });
  ...
  describe('InviteMemberResponseAllOf', function() {
    it('should create an instance of InviteMemberResponseAllOf', function() {
      // uncomment below and update the code to test InviteMemberResponseAllOf
      //var instance = new QoveryApi.InviteMemberResponseAllOf();
      //expect(instance).to.be.a(QoveryApi.InviteMemberResponseAllOf);
    });
