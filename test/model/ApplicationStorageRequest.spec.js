...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ApplicationStorageRequest();
  });
  ...
  describe('ApplicationStorageRequest', function() {
    it('should create an instance of ApplicationStorageRequest', function() {
      ...
      //var instance = new BetaQoveryApi.ApplicationStorageRequest();
      //expect(instance).to.be.a(BetaQoveryApi.ApplicationStorageRequest);
    });
