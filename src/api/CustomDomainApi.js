...
export default class CustomDomainApi {
    ...
    */
     ...
     * @callback module:api/CustomDomainApi~createHelmCustomDomainCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CustomDomain} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CustomDomainRequest} opts.customDomainRequest 
     * @param {module:api/CustomDomainApi~createHelmCustomDomainCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomDomain}
     */
     ...
     * @callback module:api/CustomDomainApi~listHelmCustomDomainCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CustomDomainResponseList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} helmId Helm ID
     * @param {module:api/CustomDomainApi~listHelmCustomDomainCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomDomainResponseList}
     */
