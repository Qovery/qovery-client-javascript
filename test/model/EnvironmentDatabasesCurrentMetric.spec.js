...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentDatabasesCurrentMetric();
  });
  ...
  describe('EnvironmentDatabasesCurrentMetric', function() {
    it('should create an instance of EnvironmentDatabasesCurrentMetric', function() {
      // uncomment below and update the code to test EnvironmentDatabasesCurrentMetric
      //var instance = new QoveryApi.EnvironmentDatabasesCurrentMetric();
      //expect(instance).to.be.a(QoveryApi.EnvironmentDatabasesCurrentMetric);
    });
