...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ApplicationPortResponsePorts();
  });
  ...
  describe('ApplicationPortResponsePorts', function() {
    it('should create an instance of ApplicationPortResponsePorts', function() {
      // uncomment below and update the code to test ApplicationPortResponsePorts
      //var instance = new BetaQoveryApi.ApplicationPortResponsePorts();
      //expect(instance).to.be.a(BetaQoveryApi.ApplicationPortResponsePorts);
    });
