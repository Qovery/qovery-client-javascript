...
class ContainerAdvancedSettings {
    ...
    /**
     * Validates the JSON data with respect to <code>ContainerAdvancedSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContainerAdvancedSettings</code>.
     */
