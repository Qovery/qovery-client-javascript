...
class JobDeploymentRestrictionRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>JobDeploymentRestrictionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JobDeploymentRestrictionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of JobDeploymentRestrictionRequest.RequiredProperties) {
            if (!data[property]) {
...
JobDeploymentRestrictionRequest.RequiredProperties = ["mode", "type", "value"];
