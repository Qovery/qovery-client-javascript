...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.DatabaseCurrentMetricMemory();
  });
  ...
  describe('DatabaseCurrentMetricMemory', function() {
    it('should create an instance of DatabaseCurrentMetricMemory', function() {
      // uncomment below and update the code to test DatabaseCurrentMetricMemory
      //var instance = new QoveryApi.DatabaseCurrentMetricMemory();
      //expect(instance).to.be.a(QoveryApi.DatabaseCurrentMetricMemory);
    });
