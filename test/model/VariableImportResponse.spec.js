...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.VariableImportResponse();
  });
  ...
  describe('VariableImportResponse', function() {
    it('should create an instance of VariableImportResponse', function() {
      ...
      //var instance = new BetaQoveryApi.VariableImportResponse();
      //expect(instance).to.be.a(BetaQoveryApi.VariableImportResponse);
    });
