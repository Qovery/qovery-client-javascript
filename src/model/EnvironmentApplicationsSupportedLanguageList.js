...
class EnvironmentApplicationsSupportedLanguageList {
    ...
    /**
     * Validates the JSON data with respect to <code>EnvironmentApplicationsSupportedLanguageList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnvironmentApplicationsSupportedLanguageList</code>.
     */
    static validateJSON(data) {
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                EnvironmentApplicationsSupportedLanguage.validateJSON(item);
            };
        }
