...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.DatabaseCurrentMetricCpu();
  });
  ...
  describe('DatabaseCurrentMetricCpu', function() {
    it('should create an instance of DatabaseCurrentMetricCpu', function() {
      // uncomment below and update the code to test DatabaseCurrentMetricCpu
      //var instance = new QoveryApi.DatabaseCurrentMetricCpu();
      //expect(instance).to.be.a(QoveryApi.DatabaseCurrentMetricCpu);
    });
