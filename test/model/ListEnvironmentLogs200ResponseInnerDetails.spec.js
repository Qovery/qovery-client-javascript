...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ListEnvironmentLogs200ResponseInnerDetails();
  });
  ...
  describe('ListEnvironmentLogs200ResponseInnerDetails', function() {
    it('should create an instance of ListEnvironmentLogs200ResponseInnerDetails', function() {
      // uncomment below and update the code to test ListEnvironmentLogs200ResponseInnerDetails
      //var instance = new QoveryApi.ListEnvironmentLogs200ResponseInnerDetails();
      //expect(instance).to.be.a(QoveryApi.ListEnvironmentLogs200ResponseInnerDetails);
    });
