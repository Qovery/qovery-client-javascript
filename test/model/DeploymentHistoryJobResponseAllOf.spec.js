...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.DeploymentHistoryJobResponseAllOf();
  });
  ...
  describe('DeploymentHistoryJobResponseAllOf', function() {
    it('should create an instance of DeploymentHistoryJobResponseAllOf', function() {
      // uncomment below and update the code to test DeploymentHistoryJobResponseAllOf
      //var instance = new QoveryApi.DeploymentHistoryJobResponseAllOf();
      //expect(instance).to.be.a(QoveryApi.DeploymentHistoryJobResponseAllOf);
    });
