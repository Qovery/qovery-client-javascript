...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.GitRepository();
  });
  ...
  describe('GitRepository', function() {
    it('should create an instance of GitRepository', function() {
      // uncomment below and update the code to test GitRepository
      //var instance = new QoveryApi.GitRepository();
      //expect(instance).to.be.a(QoveryApi.GitRepository);
    });
