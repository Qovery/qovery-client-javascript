...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ApplicationCurrentScaleResponse();
  });
  ...
  describe('ApplicationCurrentScaleResponse', function() {
    it('should create an instance of ApplicationCurrentScaleResponse', function() {
      ...
      //var instance = new BetaQoveryApi.ApplicationCurrentScaleResponse();
      //expect(instance).to.be.a(BetaQoveryApi.ApplicationCurrentScaleResponse);
    });
