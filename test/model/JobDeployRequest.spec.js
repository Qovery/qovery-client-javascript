...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.JobDeployRequest();
  });
  ...
  describe('JobDeployRequest', function() {
    it('should create an instance of JobDeployRequest', function() {
      // uncomment below and update the code to test JobDeployRequest
      //var instance = new QoveryApi.JobDeployRequest();
      //expect(instance).to.be.a(QoveryApi.JobDeployRequest);
    });
