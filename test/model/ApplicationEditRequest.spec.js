...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ApplicationEditRequest();
  });
  ...
  describe('ApplicationEditRequest', function() {
    it('should create an instance of ApplicationEditRequest', function() {
      ...
      //var instance = new BetaQoveryApi.ApplicationEditRequest();
      //expect(instance).to.be.a(BetaQoveryApi.ApplicationEditRequest);
    });
