 ...
 */
ApplicationAdvancedSettings.prototype['deployment.custom_domain_check_enabled'] = undefined;

/**
 * define how long in seconds an application is supposed to be stopped gracefully
 * @member {Number} deployment.termination_grace_period_seconds
 */
ApplicationAdvancedSettings.prototype['deployment.termination_grace_period_seconds'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['deployment.antiaffinity.pod'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['deployment.update_strategy.type'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['deployment.update_strategy.rolling_update.max_unavailable_percent'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['deployment.update_strategy.rolling_update.max_surge_percent'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['build.cpu_max_in_milli'] = undefined;

/**
 * define the max ram resources (in gib)
 * @member {Number} build.ram_max_in_gib
 */
ApplicationAdvancedSettings.prototype['build.ram_max_in_gib'] = undefined;

/**
 * @member {Number} network.ingress.proxy_body_size_mb
 */
ApplicationAdvancedSettings.prototype['network.ingress.proxy_body_size_mb'] = undefined;

/**
 * @member {Boolean} network.ingress.enable_cors
 */
ApplicationAdvancedSettings.prototype['network.ingress.enable_cors'] = undefined;

/**
 * @member {String} network.ingress.cors_allow_origin
 */
ApplicationAdvancedSettings.prototype['network.ingress.cors_allow_origin'] = undefined;

/**
 * @member {String} network.ingress.cors_allow_methods
 */
ApplicationAdvancedSettings.prototype['network.ingress.cors_allow_methods'] = undefined;

/**
 * @member {String} network.ingress.cors_allow_headers
 */
ApplicationAdvancedSettings.prototype['network.ingress.cors_allow_headers'] = undefined;

/**
 * header buffer size used while reading response header from upstream
 * @member {Number} network.ingress.proxy_buffer_size_kb
 */
ApplicationAdvancedSettings.prototype['network.ingress.proxy_buffer_size_kb'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['network.ingress.keepalive_time_seconds'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['network.ingress.keepalive_timeout_seconds'] = undefined;

/**
 * Sets a timeout (in seconds) for transmitting a response to the client
 * @member {Number} network.ingress.send_timeout_seconds
 */
ApplicationAdvancedSettings.prototype['network.ingress.send_timeout_seconds'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['network.ingress.proxy_connect_timeout_seconds'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['network.ingress.proxy_send_timeout_seconds'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['network.ingress.proxy_read_timeout_seconds'] = undefined;

/**
 * Allows to enable or disable nginx `proxy-request-buffering`
 * @member {String} network.ingress.proxy_buffering
 */
ApplicationAdvancedSettings.prototype['network.ingress.proxy_buffering'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['network.ingress.whitelist_source_range'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['network.ingress.denylist_source_range'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['network.ingress.basic_auth_env_var'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['network.ingress.enable_sticky_session'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['network.ingress.grpc_send_timeout_seconds'] = undefined;

/**
 * Sets a timeout (in seconds) for transmitting a request to the grpc server
 * @member {Number} network.ingress.grpc_read_timeout_seconds
 */
ApplicationAdvancedSettings.prototype['network.ingress.grpc_read_timeout_seconds'] = undefined;

/**
 * Allows to define response headers
 * @member {String} network.ingress.extra_headers
 */
ApplicationAdvancedSettings.prototype['network.ingress.extra_headers'] = undefined;

/**
 * Percentage value of cpu usage at which point pods should scale up.
 * @member {Number} hpa.cpu.average_utilization_percent
 */
ApplicationAdvancedSettings.prototype['hpa.cpu.average_utilization_percent'] = undefined;

/**
 * Allows you to set an existing Kubernetes service account name 
 * @member {String} security.service_account_name
 */
ApplicationAdvancedSettings.prototype['security.service_account_name'] = undefined;
 ...
 */
ApplicationAdvancedSettings.prototype['security.automount_service_account_token'] = undefined;

/**
 * Mounts the container's root filesystem as read-only 
 * @member {Boolean} security.read_only_root_filesystem
 */
ApplicationAdvancedSettings.prototype['security.read_only_root_filesystem'] = undefined;
