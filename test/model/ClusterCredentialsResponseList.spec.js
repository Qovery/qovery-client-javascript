...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ClusterCredentialsResponseList();
  });
  ...
  describe('ClusterCredentialsResponseList', function() {
    it('should create an instance of ClusterCredentialsResponseList', function() {
      ...
      //var instance = new BetaQoveryApi.ClusterCredentialsResponseList();
      //expect(instance).to.be.a(BetaQoveryApi.ClusterCredentialsResponseList);
    });
