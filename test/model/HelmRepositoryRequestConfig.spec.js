...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.HelmRepositoryRequestConfig();
  });
  ...
  describe('HelmRepositoryRequestConfig', function() {
    it('should create an instance of HelmRepositoryRequestConfig', function() {
      // uncomment below and update the code to test HelmRepositoryRequestConfig
