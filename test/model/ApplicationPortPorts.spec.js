...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ApplicationPortPorts();
  });
  ...
  describe('ApplicationPortPorts', function() {
    it('should create an instance of ApplicationPortPorts', function() {
      // uncomment below and update the code to test ApplicationPortPorts
      //var instance = new QoveryApi.ApplicationPortPorts();
      //expect(instance).to.be.a(QoveryApi.ApplicationPortPorts);
    });
