...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.OrganizationWebhookResponseAllOf();
  });
  ...
  describe('OrganizationWebhookResponseAllOf', function() {
    it('should create an instance of OrganizationWebhookResponseAllOf', function() {
      // uncomment below and update the code to test OrganizationWebhookResponseAllOf
      //var instance = new QoveryApi.OrganizationWebhookResponseAllOf();
      //expect(instance).to.be.a(QoveryApi.OrganizationWebhookResponseAllOf);
    });
