...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ClusterAllOf1();
  });
  ...
  describe('ClusterAllOf1', function() {
    it('should create an instance of ClusterAllOf1', function() {
      // uncomment below and update the code to test ClusterAllOf1
      //var instance = new QoveryApi.ClusterAllOf1();
      //expect(instance).to.be.a(QoveryApi.ClusterAllOf1);
    });
