...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.InstanceMemory();
  });
  ...
  describe('InstanceMemory', function() {
    it('should create an instance of InstanceMemory', function() {
      // uncomment below and update the code to test InstanceMemory
      //var instance = new QoveryApi.InstanceMemory();
      //expect(instance).to.be.a(QoveryApi.InstanceMemory);
    });
