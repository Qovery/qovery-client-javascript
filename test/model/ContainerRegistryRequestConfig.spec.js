...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ContainerRegistryRequestConfig();
  });
  ...
  describe('ContainerRegistryRequestConfig', function() {
    it('should create an instance of ContainerRegistryRequestConfig', function() {
      // uncomment below and update the code to test ContainerRegistryRequestConfig
      //var instance = new QoveryApi.ContainerRegistryRequestConfig();
      //expect(instance).to.be.a(QoveryApi.ContainerRegistryRequestConfig);
    });
