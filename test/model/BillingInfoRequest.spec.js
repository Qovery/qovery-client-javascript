...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.BillingInfoRequest();
  });
  ...
  describe('BillingInfoRequest', function() {
    it('should create an instance of BillingInfoRequest', function() {
      ...
      //var instance = new BetaQoveryApi.BillingInfoRequest();
      //expect(instance).to.be.a(BetaQoveryApi.BillingInfoRequest);
    });
