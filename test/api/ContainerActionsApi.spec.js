...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ContainerActionsApi();
  });
  ...
  describe('ContainerActionsApi', function() {
    describe('deployContainer', function() {
      it('should call deployContainer successfully', function(done) {
        //uncomment below and update the code to test deployContainer
        //instance.deployContainer(function(error) {
    ...
    describe('restartContainer', function() {
      it('should call restartContainer successfully', function(done) {
        ...
        //instance.restartContainer(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('stopContainer', function() {
      it('should call stopContainer successfully', function(done) {
        //uncomment below and update the code to test stopContainer
        //instance.stopContainer(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
