...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentDatabasesCurrentMetricResponse();
  });
  ...
  describe('EnvironmentDatabasesCurrentMetricResponse', function() {
    it('should create an instance of EnvironmentDatabasesCurrentMetricResponse', function() {
      ...
      //var instance = new QoveryApi.EnvironmentDatabasesCurrentMetricResponse();
      //expect(instance).to.be.a(QoveryApi.EnvironmentDatabasesCurrentMetricResponse);
    });
