...
/**
 * The ApplicationPortPorts model module.
 * @module model/ApplicationPortPorts
 * @version $(grep &#39;version&#39; _build/openapi.yaml | head -1 | tr &#39;:&#39; &#39;\n&#39; | tail -1 | tr -d &#39; &#39;)
 */
class ApplicationPortPorts {
    /**
     * Constructs a new <code>ApplicationPortPorts</code>.
     * @alias module:model/ApplicationPortPorts
    ...
    constructor(internalPort, publiclyAccessible) { 
        ...
        ApplicationPortPorts.initialize(this, internalPort, publiclyAccessible);
    }
    ...
    /**
     * Constructs a <code>ApplicationPortPorts</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationPortPorts} obj Optional instance to populate.
     * @return {module:model/ApplicationPortPorts} The populated <code>ApplicationPortPorts</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationPortPorts();
 ...
 * @member {String} id
 */
ApplicationPortPorts.prototype['id'] = undefined;

/**
 * @member {String} name
 */
ApplicationPortPorts.prototype['name'] = undefined;

/**
 * The listening port of your application
 * @member {Number} internal_port
 */
ApplicationPortPorts.prototype['internal_port'] = undefined;

/**
 * The exposed port for your application. This is optional. If not set a default port will be used.
 * @member {Number} external_port
 */
ApplicationPortPorts.prototype['external_port'] = undefined;

/**
 * Expose the port to the world
 * @member {Boolean} publicly_accessible
 */
ApplicationPortPorts.prototype['publicly_accessible'] = undefined;

/**
 * @member {module:model/PortProtocolEnum} protocol
 */
ApplicationPortPorts.prototype['protocol'] = undefined;
...
export default ApplicationPortPorts;
