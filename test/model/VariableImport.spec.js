...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.VariableImport();
  });
  ...
  describe('VariableImport', function() {
    it('should create an instance of VariableImport', function() {
      // uncomment below and update the code to test VariableImport
      //var instance = new QoveryApi.VariableImport();
      //expect(instance).to.be.a(QoveryApi.VariableImport);
    });
