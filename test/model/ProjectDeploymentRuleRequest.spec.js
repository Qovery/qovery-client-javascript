...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ProjectDeploymentRuleRequest();
  });
  ...
  describe('ProjectDeploymentRuleRequest', function() {
    it('should create an instance of ProjectDeploymentRuleRequest', function() {
      // uncomment below and update the code to test ProjectDeploymentRuleRequest
      //var instance = new BetaQoveryApi.ProjectDeploymentRuleRequest();
      //expect(instance).to.be.a(BetaQoveryApi.ProjectDeploymentRuleRequest);
    });
