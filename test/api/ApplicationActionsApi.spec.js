...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.ApplicationActionsApi();
  });
  ...
  describe('ApplicationActionsApi', function() {
    describe('deployApplication', function() {
      it('should call deployApplication successfully', function(done) {
        //uncomment below and update the code to test deployApplication
        //instance.deployApplication(function(error) {
