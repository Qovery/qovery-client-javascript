...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.HelmRequestAllOfValuesOverride();
  });
  ...
  describe('HelmRequestAllOfValuesOverride', function() {
    it('should create an instance of HelmRequestAllOfValuesOverride', function() {
      // uncomment below and update the code to test HelmRequestAllOfValuesOverride
      //var instance = new QoveryApi.HelmRequestAllOfValuesOverride();
      //expect(instance).to.be.a(QoveryApi.HelmRequestAllOfValuesOverride);
    });
