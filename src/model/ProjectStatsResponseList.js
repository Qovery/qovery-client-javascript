...
class ProjectStatsResponseList {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [ProjectStats]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectStatsResponseList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectStatsResponseList</code>.
     */
    static validateJSON(data) {
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                ProjectStats.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/ProjectStats>} results
 */
