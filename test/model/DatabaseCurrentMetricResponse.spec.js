...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.DatabaseCurrentMetricResponse();
  });
  ...
  describe('DatabaseCurrentMetricResponse', function() {
    it('should create an instance of DatabaseCurrentMetricResponse', function() {
      ...
      //var instance = new QoveryApi.DatabaseCurrentMetricResponse();
      //expect(instance).to.be.a(QoveryApi.DatabaseCurrentMetricResponse);
    });
