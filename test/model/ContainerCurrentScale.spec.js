...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ContainerCurrentScale();
  });
  ...
  describe('ContainerCurrentScale', function() {
    it('should create an instance of ContainerCurrentScale', function() {
      // uncomment below and update the code to test ContainerCurrentScale
      //var instance = new QoveryApi.ContainerCurrentScale();
      //expect(instance).to.be.a(QoveryApi.ContainerCurrentScale);
    });
