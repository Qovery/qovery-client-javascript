...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.MetricMemoryDatapointResponse();
  });
  ...
  describe('MetricMemoryDatapointResponse', function() {
    it('should create an instance of MetricMemoryDatapointResponse', function() {
      ...
      //var instance = new BetaQoveryApi.MetricMemoryDatapointResponse();
      //expect(instance).to.be.a(BetaQoveryApi.MetricMemoryDatapointResponse);
    });
