...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.OrganizationWebhookResponse();
  });
  ...
  describe('OrganizationWebhookResponse', function() {
    it('should create an instance of OrganizationWebhookResponse', function() {
      // uncomment below and update the code to test OrganizationWebhookResponse
      //var instance = new QoveryApi.OrganizationWebhookResponse();
      //expect(instance).to.be.a(QoveryApi.OrganizationWebhookResponse);
    });
