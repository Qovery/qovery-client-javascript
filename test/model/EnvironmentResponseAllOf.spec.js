...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentResponseAllOf();
  });
  ...
  describe('EnvironmentResponseAllOf', function() {
    it('should create an instance of EnvironmentResponseAllOf', function() {
      // uncomment below and update the code to test EnvironmentResponseAllOf
      //var instance = new QoveryApi.EnvironmentResponseAllOf();
      //expect(instance).to.be.a(QoveryApi.EnvironmentResponseAllOf);
    });
