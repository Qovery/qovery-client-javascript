...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ContainerEditRequestAllOf();
  });
  ...
  describe('ContainerEditRequestAllOf', function() {
    it('should create an instance of ContainerEditRequestAllOf', function() {
      // uncomment below and update the code to test ContainerEditRequestAllOf
      //var instance = new QoveryApi.ContainerEditRequestAllOf();
      //expect(instance).to.be.a(QoveryApi.ContainerEditRequestAllOf);
    });
