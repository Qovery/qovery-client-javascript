...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.OrganizationCurrentCost();
  });
  ...
  describe('OrganizationCurrentCost', function() {
    it('should create an instance of OrganizationCurrentCost', function() {
      // uncomment below and update the code to test OrganizationCurrentCost
      //var instance = new QoveryApi.OrganizationCurrentCost();
      //expect(instance).to.be.a(QoveryApi.OrganizationCurrentCost);
    });
