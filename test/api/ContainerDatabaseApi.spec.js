...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ContainerDatabaseApi();
  });
  ...
  describe('ContainerDatabaseApi', function() {
    describe('attachLogicalDatabaseToContainer', function() {
      it('should call attachLogicalDatabaseToContainer successfully', function(done) {
        ...
        //instance.attachLogicalDatabaseToContainer(function(error) {
    ...
    describe('removeLogicalDatabaseFromContainer', function() {
      it('should call removeLogicalDatabaseFromContainer successfully', function(done) {
        //uncomment below and update the code to test removeLogicalDatabaseFromContainer
        //instance.removeLogicalDatabaseFromContainer(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
