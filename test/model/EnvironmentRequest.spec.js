...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BetaQoveryApi.EnvironmentRequest();
  });
  ...
  describe('EnvironmentRequest', function() {
    it('should create an instance of EnvironmentRequest', function() {
      ...
      //var instance = new BetaQoveryApi.EnvironmentRequest();
      //expect(instance).to.be.a(BetaQoveryApi.EnvironmentRequest);
    });
