...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.VariableAlias();
  });
  ...
  describe('VariableAlias', function() {
    it('should create an instance of VariableAlias', function() {
      // uncomment below and update the code to test VariableAlias
      //var instance = new QoveryApi.VariableAlias();
      //expect(instance).to.be.a(QoveryApi.VariableAlias);
    });
