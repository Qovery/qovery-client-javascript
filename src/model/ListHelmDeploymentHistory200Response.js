...
class ListHelmDeploymentHistory200Response {
     ...
     * @implements module:model/ListHelmDeploymentHistory200ResponseAllOf
     * @param page {Number} 
     * @param pageSize {Number} 
     */
    constructor(page, pageSize) { 
        PaginationData.initialize(this, page, pageSize);ListHelmDeploymentHistory200ResponseAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ListHelmDeploymentHistory200ResponseAllOf.constructFromObject(data, obj);
