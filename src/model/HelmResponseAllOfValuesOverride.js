...
class HelmResponseAllOfValuesOverride {
    ...
    /**
     * Validates the JSON data with respect to <code>HelmResponseAllOfValuesOverride</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HelmResponseAllOfValuesOverride</code>.
     */
    static validateJSON(data) {
        ...
        if (data['file']) { // data not null
          HelmResponseAllOfValuesOverrideFile.validateJSON(data['file']);
        }
