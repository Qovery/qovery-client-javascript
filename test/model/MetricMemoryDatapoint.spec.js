...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.MetricMemoryDatapoint();
  });
  ...
  describe('MetricMemoryDatapoint', function() {
    it('should create an instance of MetricMemoryDatapoint', function() {
      // uncomment below and update the code to test MetricMemoryDatapoint
      //var instance = new QoveryApi.MetricMemoryDatapoint();
      //expect(instance).to.be.a(QoveryApi.MetricMemoryDatapoint);
    });
