...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.GitTokenAssociatedServiceResponse();
  });
  ...
  describe('GitTokenAssociatedServiceResponse', function() {
    it('should create an instance of GitTokenAssociatedServiceResponse', function() {
      // uncomment below and update the code to test GitTokenAssociatedServiceResponse
      //var instance = new QoveryApi.GitTokenAssociatedServiceResponse();
      //expect(instance).to.be.a(QoveryApi.GitTokenAssociatedServiceResponse);
    });
