...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.ContainerResponseAllOf();
  });
  ...
  describe('ContainerResponseAllOf', function() {
    it('should create an instance of ContainerResponseAllOf', function() {
      // uncomment below and update the code to test ContainerResponseAllOf
      //var instance = new QoveryApi.ContainerResponseAllOf();
      //expect(instance).to.be.a(QoveryApi.ContainerResponseAllOf);
    });
