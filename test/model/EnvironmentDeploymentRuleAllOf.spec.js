...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentDeploymentRuleAllOf();
  });
  ...
  describe('EnvironmentDeploymentRuleAllOf', function() {
    it('should create an instance of EnvironmentDeploymentRuleAllOf', function() {
      // uncomment below and update the code to test EnvironmentDeploymentRuleAllOf
      //var instance = new QoveryApi.EnvironmentDeploymentRuleAllOf();
      //expect(instance).to.be.a(QoveryApi.EnvironmentDeploymentRuleAllOf);
    });
