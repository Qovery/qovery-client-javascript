...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.EnvironmentDatabasesCurrentMetricMemory();
  });
  ...
  describe('EnvironmentDatabasesCurrentMetricMemory', function() {
    it('should create an instance of EnvironmentDatabasesCurrentMetricMemory', function() {
      // uncomment below and update the code to test EnvironmentDatabasesCurrentMetricMemory
      //var instance = new QoveryApi.EnvironmentDatabasesCurrentMetricMemory();
      //expect(instance).to.be.a(QoveryApi.EnvironmentDatabasesCurrentMetricMemory);
    });
