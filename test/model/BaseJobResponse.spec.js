...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.BaseJobResponse();
  });
  ...
  describe('BaseJobResponse', function() {
    it('should create an instance of BaseJobResponse', function() {
      // uncomment below and update the code to test BaseJobResponse
      //var instance = new QoveryApi.BaseJobResponse();
      //expect(instance).to.be.a(QoveryApi.BaseJobResponse);
    });
