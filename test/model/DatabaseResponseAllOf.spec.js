...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.DatabaseResponseAllOf();
  });
  ...
  describe('DatabaseResponseAllOf', function() {
    it('should create an instance of DatabaseResponseAllOf', function() {
      // uncomment below and update the code to test DatabaseResponseAllOf
      //var instance = new QoveryApi.DatabaseResponseAllOf();
      //expect(instance).to.be.a(QoveryApi.DatabaseResponseAllOf);
    });
