...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QoveryApi.OrganizationApiToken();
  });
  ...
  describe('OrganizationApiToken', function() {
    it('should create an instance of OrganizationApiToken', function() {
      // uncomment below and update the code to test OrganizationApiToken
      //var instance = new QoveryApi.OrganizationApiToken();
      //expect(instance).to.be.a(QoveryApi.OrganizationApiToken);
    });
